...
const ListChat = () => {
  ...
  async function getConversation() {
    ...
    try {
      const data = await APIService.getConversation(
        segment,
        blockChoose,
        apartment,
        search,
  ...
  async function reply() {
    ...
    try {
      const data = await APIService.replyChat(
        chatChoose.id,
        type,
  ...
  async function getDetail(id) {
    try {
      const data = await APIService.getDetailConversation(id);
      if (data) {
